...
const EditCategory = {
    async render(id) {
        ...
        <form action="#" method="POST" id="from_edit">
              ...
              <div class="grid grid-cols-3 gap-6">
                ...
                Tên danh mục
                  ...
                  <div class="mt-1 flex rounded-md shadow-sm">
                    <input type="nunber" value="${data.title}" name="company-website" id="title_category" class="focus:ring-indigo-500 focus:border-indigo-800 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="Mời bạn nhập danh mục...">
                  </div>
                </div>
              </div>
            </div>
    ...
    afterRender(id) {
        const formEdit = document.querySelector("#from_edit");
